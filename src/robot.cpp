...
RobotDeviceInterfaces::RobotDeviceInterfaces() {
    ...
    this->arm_motor = new pros::Motor(1, MOTOR_GEARSET_36, false, MOTOR_ENCODER_DEGREES);
    this->tray_motor = new pros::Motor(19, MOTOR_GEARSET_36, true, MOTOR_ENCODER_DEGREES);
